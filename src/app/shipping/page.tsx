        ...
        <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#36305c] text-white font-semibold rounded-md shadow-lg hover:bg-[#4a3e74] disabled:bg-gray-400"
            >
          ...
          {rateId && (
            <button
              ...
              disabled={loading}
              className="mt-6 w-full py-3 bg-[#36305c] text-white font-semibold rounded-md shadow-lg hover:bg-[#4a3e74] disabled:bg-gray-400"
            >
          ...
          {labelPdf && (
            <div className="text-center mt-8">
              <Link href={labelPdf} target="_blank">
                <button className="px-8 py-3 bg-[#36305c] text-white font-semibold rounded-md shadow-lg hover:bg-[#4a3e74]">
                  Download Shipping Label
                </button>
              </Link>
            </div>
          ...
          {trackingObj && (
            <div className="mt-8 text-[#505977]">
              <h2 className="text-xl font-semibold text- mb-4 text-[#2A254B]">
                Tracking Details
              </h2>
              <p>
              ...
              <Link href={`/tracking/?labelId=${trackingObj.labelId}`}>
                <button className="mt-4 px-6 py-3 bg-[#36305c] text-white font-semibold rounded-md shadow-lg hover:bg-[#4a3e74]">
                  Track Shipment
                </button>
              </Link>
            </div>
